...
| [INTEGRATIONS.md](INTEGRATIONS.md) | Every external system this connects to — Tenable, Armis, ServiceNow, CISA KEV, FIRST.org EPSS — and precisely what's live-verified versus built-against-docs-but-unverified for each. Plus what's deliberately not built yet (SIEM/XDR adapters). |
...
- [../TEST_CASES.md](../TEST_CASES.md) — the full test case log (182 cases, steps,
  expected vs. actual).
