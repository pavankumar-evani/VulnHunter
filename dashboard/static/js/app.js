...
const routes = [
  ...
  { pattern: /^\/tenable\/?$/, load: () => import("./pages/tenable.js") },
  { pattern: /^\/qualys\/?$/, load: () => import("./pages/qualys.js") },
  { pattern: /^\/prismacloud\/?$/, load: () => import("./pages/prismacloud.js") },
  { pattern: /^\/cortex-xsiam\/?$/, load: () => import("./pages/cortexXsiam.js") },
